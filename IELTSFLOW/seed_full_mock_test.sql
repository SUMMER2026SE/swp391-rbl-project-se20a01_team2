...
VALUES ('Cambridge IELTS 18 - Test 1', 'Mock Test', 'All', 180, @MentorID);
...
INSERT INTO QuestionResource (ResourceName, ResourceText, ResourceAudioURL, Type, CreatedBy)
VALUES ('Listening Part 2 – Public Talk', '<div style="text-align: center; margin-bottom: 1rem;"><strong style="font-size: 1.1rem; color: #1e293b;">Map of the Sports Centre</strong><br><br><img src="https://i.ibb.co/L5hY8K8/ielts-map-sample.jpg" alt="Map" style="max-width: 100%; border-radius: 8px; border: 1px solid #cbd5e1; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"></div>', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', 'Audio', @MentorID);
