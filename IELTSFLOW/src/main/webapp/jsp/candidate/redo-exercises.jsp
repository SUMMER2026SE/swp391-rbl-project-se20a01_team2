                                ...
                                <div class="summary-grid animate-fade-up" style="animation-delay:0.05s;">
                                    ...
                                    <div class="summary-card">
                                        ...
                                        <div class="s-value green">
                                            <c:choose>
                                                <c:when test="${avgBand > 0}">
                                                    <fmt:formatNumber value="${avgBand}" pattern="0.0" />
                                                </c:when>
                                    ...
                                    <div class="summary-card">
                                        ...
                                        <div class="s-value orange">
                                            <c:choose>
                                                <c:when test="${maxBand > 0}">
                                                    <fmt:formatNumber value="${maxBand}" pattern="0.0" />
                                                </c:when>
                                                <c:otherwise>—</c:otherwise>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="chart-header">
                                            ...
                                            <div class="legend">
                                                <div class="legend-item">
                                                    <div class="legend-dot" style="background:#10b981;"></div>Listening
                                                </div>
                                                <div class="legend-item">
                                                    <div class="legend-dot" style="background:#3b82f6;"></div>Reading
                                                </div>
                                                <div class="legend-item">
                                                    <div class="legend-dot" style="background:#f59e0b;"></div>Writing
                                                </div>
                                                <div class="legend-item">
                                                    <div class="legend-dot" style="background:#ec4899;"></div>Speaking
                                                </div>
                                                <div class="legend-item">
                                                    <div class="legend-dot" style="background:#8b5cf6;"></div>Overall
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <c:forEach var="sub" items="${submissions}"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${sub.examType == 'Placement Test'}">
                                                                                    <a href="${pageContext.request.contextPath}/candidate/placement-test?action=result&submissionId=${sub.submissionId}"
                                                                                ...
                                                                                <c:otherwise>
                                                                                    <a href="${pageContext.request.contextPath}/candidate/mock-test?action=result&submissionId=${sub.submissionId}"
                                                                                        style="color:var(--text-primary);text-decoration:none;"
                                                                                        onmouseover="this.style.color='var(--accent-blue)'"
                                                                                        onmouseout="this.style.color='var(--text-primary)'">
                                                                                        ${sub.examTitle}
                                                                            ...
                                                                            <c:if test="${not empty sub.examType}">
                                                                                <span class="badge badge-blue"
                                                                                    style="margin-left:6px;font-size:0.7rem;">${sub.examType}</span>
                                                                            </c:if>
                                                                        </td>
                                                                        <td
                                                                            ...
                                                                            <div>
                                                                                <fmt:formatDate
                                                                                    value="${sub.startTimeAsDate}"
                                                                                    pattern="dd/MM/yyyy HH:mm" />
                                                                            </div>
                                                                            <div
                                                                                style="color:var(--accent-blue); margin-top:4px;">
                                                                                ⏱️ ${sub.durationString}</div>
                                                                        </td>
                                                                        <%-- Band chips: L R W S --%>
                                                                            <c:set var="bands"
                                                                                value="${[sub.listeningBand, sub.readingBand, sub.writingBand, sub.speakingBand]}" />
                                                                            <c:forEach var="b" items="${bands}">
                                                                                <td>
                                                                                    <c:choose>
                                                                                        <c:when test="${b != null}">
                                                                                            <span
                                                                                                class="band-chip has-val">
                                                                                                <fmt:formatNumber
                                                                                                    value="${b}"
                                                                                                    pattern="0.0" />
                                                                                            </span>
                                                                            ...
                                                                            <td>
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${sub.overallBand != null}">
                                                                                        <strong
                                                                                            style="color:var(--accent-blue);">
                                                                                            <fmt:formatNumber
                                                                                                value="${sub.overallBand}"
                                                                                                pattern="0.0" />
                                                                                        </strong>
                                                                                    </c:when>
                                                                                    <c:otherwise><span
                                                                            ...
                                                                            <td>
                                                                                <span
                                                                                    class="status-badge ${sub.status}">${sub.status}</span>
                                                                                <c:if test="${sub.cheated}">
                                                                                    <span title="Vi phạm"
                                                                                        style="color:var(--accent-red);font-size:.75rem;margin-left:4px;">⚠️</span>
                                                                                </c:if>
                                                                            </td>
                                                                            <td>
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${sub.examType == 'Placement Test'}">
                                                                                        <a href="${pageContext.request.contextPath}/candidate/placement-test?action=result&submissionId=${sub.submissionId}"
                                                                                            style="display:inline-block;padding:6px 12px;background:rgba(59,130,246,0.1);color:var(--accent-blue);border-radius:6px;text-decoration:none;font-size:0.8rem;font-weight:600;transition:all 0.2s;"
                                                                                            onmouseover="this.style.background='var(--accent-blue)';this.style.color='#fff';"
                                                                                            onmouseout="this.style.background='rgba(59,130,246,0.1)';this.style.color='var(--accent-blue)';">Xem
                                                                                            chi tiết</a>
                                                                                    </c:when>
                                                                                    <c:otherwise>
                                                                                        <a href="${pageContext.request.contextPath}/candidate/mock-test?action=result&submissionId=${sub.submissionId}"
