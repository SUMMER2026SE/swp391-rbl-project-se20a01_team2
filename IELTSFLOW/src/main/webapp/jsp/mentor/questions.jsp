                ...
                <table class="table table-custom mb-0">
                    ...
                    <tbody>
                        <c:forEach var="q" items="${questions}">
                            <tr>
                                <td class="text-center ps-4"><input type="checkbox" class="form-check-input item-checkbox" value="${q.questionId}"></td>
                                <td class="text-secondary">#${q.questionId}</td>
                        ...
                        <c:if test="${empty questions}">
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">Không có câu hỏi nào.</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
...
<form id="bulkDeleteForm" action="${pageContext.request.contextPath}/mentor/questions" method="POST" style="display: none;">
...
function confirmBulkDelete() {
    ...
    Swal.fire({
        ...
        text: 'Bạn đang chuẩn bị xóa ' + checked.length + ' câu hỏi. Hành động này không thể hoàn tác!',
        icon: 'warning',
