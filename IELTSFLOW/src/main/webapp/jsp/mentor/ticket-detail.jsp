...
<head>
    ...
    <title>Issue Detail - IELTSFlow Mentor</title>
    ...
    <style>
        ...
        .btn { padding: 5px 16px; border-radius: 6px; font-size: 14px; font-weight: 500; cursor: pointer; border: 1px solid transparent; display: inline-block; text-decoration: none;}
        ...
        .alert-info { background-color: #ddf4ff; color: #0969da; padding: 16px; border-radius: 6px; border: 1px solid #54aeff; margin-top: 24px; text-align: center;}
    </style>
</head>
<body>
...
<div class="layout-wrapper">
    ...
    <main class="main-content">
        <div class="animate-fade-up">
            <a href="${pageContext.request.contextPath}/mentor/tickets" class="back-link">
                                ...
                                <div class="comment-form-container">
                                    ...
                                    <div class="comment-form">
                                        ...
                                        <form method="POST" action="${pageContext.request.contextPath}/mentor/tickets">
                                            ...
                                            <textarea name="content" class="comment-textarea" placeholder="Leave a comment (Markdown is supported)"></textarea>
                            ...
                            <div class="sidebar-section">
                                ...
                                <c:choose>
                                    <c:when test="${ticket.status == 'InProgress'}">
                                        <span class="label-badge label-inprogress" style="display:inline-block; padding: 2px 8px; border-radius: 2em; background-color: #d4a72c; color: #fff; font-size: 12px; font-weight: 500;">in progress</span>
                                    </c:when>
                                    <c:when test="${ticket.status == 'Resolved'}">
                                        <span class="label-badge label-resolved" style="display:inline-block; padding: 2px 8px; border-radius: 2em; background-color: #2da44e; color: #fff; font-size: 12px; font-weight: 500;">resolved</span>
                                    </c:when>
                                    <c:otherwise>
