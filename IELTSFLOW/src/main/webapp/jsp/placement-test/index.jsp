                ...
                <c:choose>
                    <c:when test="${exam != null}">
                        <div class="exam-card">
                            ...
                            <form action="${pageContext.request.contextPath}/candidate/placement-test" method="post">
                                <input type="hidden" name="action" value="start">
                                <button type="submit" class="btn-start-placement" id="btn-start-placement-test">
                                    🚀 Bắt đầu thi ngay
                                </button>
                            </form>
                        </div>
